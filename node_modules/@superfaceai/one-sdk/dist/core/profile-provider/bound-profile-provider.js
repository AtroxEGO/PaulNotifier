...
var BoundProfileProvider = /** @class */ (function () {
    ...
    BoundProfileProvider.prototype.composeInput = function (usecase, input) {
        var _a, _b, _c;
        var composed = input;
        var defaultInput = lib_1.castToNonPrimitive((_b = (_a = this.configuration.profileProviderSettings) === null || _a === void 0 ? void 0 : _a.defaults[usecase]) === null || _b === void 0 ? void 0 : _b.input);
        if (defaultInput !== undefined) {
            composed = lib_1.mergeVariables(defaultInput, input !== null && input !== void 0 ? input : {});
