...
function sourceFileExtensionFoundError(extension) {
    return new lib_1.SDKExecutionError(extension + " extension found.", [], [extension + " files needs to be compiled with Superface CLI."]);
}
...
function missingPathReplacementError(missing, url, all, available) {
    return new lib_1.SDKExecutionError("Missing values for URL path replacement: " + missing.join(', '), [
