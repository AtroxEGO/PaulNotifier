...
var DigestHandler = /** @class */ (function () {
        ...
        this.authenticate = function (parameters) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        credentials = _c.sent();
                        return [2 /*return*/, __assign(__assign({}, parameters), { headers: __assign(__assign({}, headers), (_a = {}, _a[(_b = this.configuration.authorizationHeader) !== null && _b !== void 0 ? _b : interfaces_1.DEFAULT_AUTHORIZATION_HEADER_NAME] = credentials, _a)) })];
                }
            });
        }); };
        this.handleResponse = function (response, resourceRequestParameters) { return __awaiter(_this, void 0, void 0, function () {
            var configurationHash, credentials, prepared;
            var _a;
            var _this = this;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        credentials = this.fetchInstance.digest.getCached(configurationHash, function () {
                            ...
                            // We need actual resolved url
                            response.debug.request.url, resourceRequestParameters.method, _this.extractDigestValues(response.headers[_this.challengeHeader]));
                        });
    ...
    DigestHandler.prototype.extractDigestValues = function (header) {
        var _a, _b;
        (_a = this.logSensitive) === null || _a === void 0 ? void 0 : _a.call(this, "Extracting digest authentication values from: " + header);
