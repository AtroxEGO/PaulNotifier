...
var bodyFilter = function (_a) {
    ...
    if (parameters.body !== undefined) {
        if (parameters.contentType === interfaces_2.JSON_CONTENT) {
            ...
            finalBody = interfaces_2.urlSearchParamsBody(lib_1.variablesToStrings(parameters.body));
        }
        else if (parameters.contentType === interfaces_2.FORMDATA_CONTENT) {
            var body = lib_1.castToNonPrimitive(parameters.body);
            if (body) {
                finalBody = interfaces_2.formDataBody(body);
            }
        }
...
var queryParametersFilter = function (_a) {
    ...
    var queryParameters = __assign(__assign({}, request === null || request === void 0 ? void 0 : request.queryParameters), lib_1.variablesToStrings(parameters.queryParameters));
    return {
        parameters: parameters,
        response: response,
...
function isCompleteHttpRequest(input) {
    ...
    if (input.queryParameters !== undefined) {
        ...
        if (!Object.values(input.queryParameters).every(function (value) { return typeof value === 'string'; })) {
            return false;
        }
    }
